            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text">lipstick moist</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Mirabella Chic Colormoist Lipstick.
                        <br>
                        Mengandung Vitamin E dan moisturizer untuk menjaga kelembaban dan kelembutan bibir.
                        <br>
                        Lipstick ini tahan lama dan tidak membuat bibir terasa kering.
                        <br>
                        Cocok untuk semua jenis bibir dan bisa digunakan untuk sehari-hari.
                        <br>
                        <br>
                        Manfaat :
                        <br>
                        <br>
                        Untuk menyempurnakan riasan bibir.
                        <br>
                        Menghindari bibir pecah-pecah.
                        <br>
                        Menjaga bibir dari pengaruh buruk lingkungan.
                        <br>
                        <br>
                        Keunggulan :
                        <br>
                        ...
                        <br>
                        menjaga kelembaban dan kelembutan bibir.
                        <br>
                        Kandungan
                        <br>
