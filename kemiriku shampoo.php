        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/shampoo/kemiriku.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">HAPPY KEMIRIKU</h5>
                        <p class="card-text">For All Hair Types</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        <br>
                        Shampoo kemiriku untuk Mengkilapkan rambut hitam dan menerangi rambut bercabang serta Menutrisi rambut dan kulit kepala dan mencegah ketombe pada akar rambut dan Menjaga rambut tetap sehat dan tebal. 
                        <br>
                        <br>
                        <br>
                        Cara Pakai : 
                        <br>
                        Gunakan secara rutin agar hasil maksimal. Tuangkan shampoo kemiri secukupkan ratakan pada rambut pijat secara merata lalu bilas.
                        </p>
                    </div>
                </div>
                </div>
