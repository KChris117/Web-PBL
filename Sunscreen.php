        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                ...
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        <h5 class="card-title">The Originote</h5>
                        <p class="card-text">Ceramella Sunscreen SPF 50 PA+++</p>
                        <p class="card-text">
                            The Originote Ceramella Sunscreen SPF 50 PA+++
                            <br> Netto 50gr
                            <br> Purchase Limit: 5
                            <br> The Originote Ceramella Sunscreen merupakan sunscreen hybrid (chemical dan physical) dengan SPF 50 PA+++ dengan
                            kandungan 3 jenis Ceramide, Tremella dan Vitamin C yang berfungsi untuk melindungi kulit terhadap efek buruk dari sinar
                            matahari, melindungi kulit dari penuaan dini yang disebabkan oleh efek buruk dari sinar matahari dan sekaligus mebantu
                            merawat skin barrier.
                            <br>
                            <br> MANFAAT
                            <br> Melindungi kulit dari kerusakan akibat sinar matahariMembantu merawat skin barrier
                            <br> Merawat skin barrier
                        </p>
                    </div>
                </div>
