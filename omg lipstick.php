        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/lipstick/omg.jpeg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">OMG (Oh My Glam)</h5>
                        <p class="card-text">Kiss Lip Cream</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        OMG Oh My Glam Matte Kiss Lip Cream 3.5 gr
                        <br>
                        <br>
                        Lipcream dengan pilihan warna Warna Menawan
                        <br>
                        <br>
                        ✔️Tahan Lama
                        <br>
