        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/lipstick/brasov.jpeg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Brasov</h5>
                        <p class="card-text">Pigmented Perona</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        BRASOV Lipstick Matte Shade 01 - 08 
                        <br>
                        Produk dijamin Original
                        <br>
                        Terbuat dari bahan yang aman & berkualitas
                        <br>
                        Ukuran produk ± 2 x 2 x 7.5 CM, netto : 3.8 gr
                        <br>
                        Tersedia shade 01, 02, 03, 04, 05, 06, 07, 08, hasil akhir matte, aroma berry
                        <br>
                        Lulus uji BPOM, awet, warna pigmented, tidak lengket & kering
                        <br>
                        Untuk memperindah tampilan bibir
                        <br>
                        <br>
                        Ukuran Paket: 3 x 3 x 9 CM
                        <br>
                        Berat: 0,02 KG
                        <br>
                        Berat Pengiriman: 0,02 KG
                        </p>
                    </div>
                </div>
                </div>
