        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Produk ORIGINAL langsung dari Pusat mohon jangan ditanyakan lgi!
                        <br>
                        <br>
                        Mengandung : VITAMIN C ESSENCE
                        <br>
                        TEKSTURNYA FULL
                        <br>
                        MELEMBABKAN KULIT                        
                        <br>
                        PEMUTIH KULIT DAN LEMBUT
                        <br>
                        MEMBUAT KULIT HALUS DAN PUTIH
                        <br>
                        Kapasitas losion tubuh 250g
                        <br>
                        <br>
                        Cara pemakaian : Setelah membersihkan kulit atau mandi, ambil dengan jumlah yang tepat dari body lotion dan menerapkannya secara merata pada seluruh tubuh atau pada area yang perlu diperbaiki, dan dengan lembut pijat sampai meresap.
                        </p>
                    </div>
                </div>
                </div>
