        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Shampoo untuk rambut kuat dan lebat 
                        <br>
                        - Membantu rambut agar tetap kuat dan lebat dengan kilau alami 
                        <br>
                        - Membantu menjaga kekuatan rambut sehingga rambut fleksibel dan tidak mudah patah 
                        <br>
                        Mengandung: Biotin, Pro-V, Anti-Oxidant 
                        <br>
                        <br>
                        Pantene Pro-V Gold Series Smooth & Sleek Shampoo 450 ml
                        <br>
                        - Rambut lembut dan mudah diatur 
                        <br>
                        -Rambut lembut sepanjang hari 
                        <br>
                        - Membantu menjaga kekuatan rambut sehingga rambut fleksibel dan tidak mudah patah 
                        <br>
                        Gunakan Pantene Kondisioner untuk rambut yang lembut dan mudah diatur
                        </p>
                    </div>
                </div>
                </div>
