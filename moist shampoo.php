        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/shampoo/moist.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Moist Diane</h5>
                        <p class="card-text">Perfect Beauty</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp110.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        <br>
                        Moist Diane Shampoo adalah produk perawatan rambut dari Jepang yang terbuat dari bahan-bahan alami. Bahan utama shampoo ini yaitu Organic Argan Oil yang dapat menjaga kelembaban dan merawat rambut tanpa membuatnya lepek
                        <br>
                        Shampoo ini juga tidak mengandung silicones (pada shampoo), sulphates, dan parabens, sehingga aman untuk pemakaian setiap hari.
                        </p>
                    </div>
                </div>
                </div>
