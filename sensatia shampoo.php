        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/shampoo/sensatia.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Sensatia</h5>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        <br>
                        Rambut yang berkilau dan tidak kusut dapat diraih dengan penggunaan Hydrating Shampoo secara teratur. Formulanya yang unik mengandung zat aktif dari tumbuhan yang membersihkan kotoran serta menutrisi kulit kepala dan rambut. Campuran minyak esensial memberikan aroma citrus yang menyegarkan juga menghasilkan rambut yang kuat dan berkilau. 
                        </p>
                    </div>
                </div>
                </div>
