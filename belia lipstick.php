        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/lipstick/belia.jpeg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Belia</h5>
                        <p class="card-text">Lip Crayon Satin</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Implora Lip Crayon Satin dengan formula yang mengandung berbagai omega 3,6,9 dan Vitamin C 
                        <br>
                        yang berfungsi membantu menjaga kelembaban alami bibir hingga tampak memukau dan memberikan  
                        <br>
                        hasil akhir warna creamy / satin pada bibir serta tahan lama. Dengan ujung lip crayon yang mudah diaplikasikan ke bibir.
                        <br>
                        <br>
                        ✔️ BPOM di kemasan
                        <br>
