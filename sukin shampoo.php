    ...
    <div class="row mt-5 no-gutter">
        <div class="col-md-2 bg-light">
            <ul class="list-group list-group-flush p-2 pt-4">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light bg-secondary" href="shampoo.php">Shampoo<span class="sr-only"></span></a>
                </li>
            </ul>
        </div>
        <br>
        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/shampoo/sukin.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">SUKIN HAIRCARE</h5>
                        <p class="card-text">DEEP CLEANSE</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp155.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        <br>
                        Bebas dari sulfat, silikon dan bahan kimia keras yang dapat mengeringkan dan mengupas rambut dan kulit kepala Anda, Sukin Hydrating Kondisioner kaya akan Mentega Shea , Kelapa dan Minyak Wijen untuk membantu menutrisi, memperkuat dan memperbaiki rambut kering dan rusak secara alami! Infus Minyak Zaitun dan Vitamin E menambah kilau pada rambut kusam dan membantu mengurangi kusut. Rambut dibiarkan terasa sangat terhidrasi, lembut dan lebih mudah diatur, sementara aroma Kelapa dan Jeruk Nipis menyegarkan indra!
                        </p>
                    </div>
                </div>
                </div>
