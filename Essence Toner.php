        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/skincare/images1.jpeg" class="card-img-top" alt="...">
                ...
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text">
                            ...
                            <br> Netto 80ml
                            <br> Purchase Limit: 5
                            <br> Essence Toner yang diformulasikan dengan Ceramide, 
                            Hyluron dan Heartleaf yang dapat membantu dalam merawat skin barrier, 
                            sebagai penyegar kulit yang teiritasi secara ringan. Membantu menyejukkan kulit 
                            dan menjaga hidrasi pada wajah.
                            <br>
                            <br> MANFAAT
                            <br> Membantu merawat skin barrier
                            <br> Membantu menenangkan iritasi ringan pada kulit
                        </p>
                    </div>
                </div>
