            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        Manfaat :
                        <br>
                        Mengandung minyak biji delima, sebagai anti oksidan untuk merawat elastisitas dan kelembaban kulit
                        <br>
                        Mengandung ekstrak Pink Pomelo, sebagai bahan aktif yang membantu menjadikan warna kulit tetap cerah walau sering beraktifitas di luar ruangan.
                        <br>
                        Mengandung ekstrak Blue Daisy, sebagai bahan aktif yang membantu merawat kulit kemerahan karena iritasi ringan.
                        <br>
                        Mengandung Sea Butter dan Vegetable Squalene yang melembabkan kulit dengan maksimal.
                        <br>
                        Mengandung ekstrak Lyllac dan Holyherb, sebagai bahan aktif yang membantu proses regenerasi kulit dan menutrisi kulit selama tidur dengan sensasi aromaterapi
                        <br>
                        Mengandung Astaxanthin dan Lycopene, yang merupakan antioksidan dari bahan alami, yang menjadikan kulit halus, sehat, dan tampak kencang.
                        <br>
                        <br>
                        Semuanya mengandung butiran Vitamin E dan Natural Moisturizing Factor, yang memberikan kelembaban maksimal pada kulit. Aman dipakai sehari-hari karena diproduksi dengan teknologi modern.
                        </p>
                    </div>
                </div>
                </div>
