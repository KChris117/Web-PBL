        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/mydance.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Mydance</h5>
                        <p class="card-text">UV GEL POLISH</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        My Dance UV Nail Polish Cat Kuku Gel UV LED Jepang 
                        <br>
                        Cat Kuku Herbal Alami Jepang, Tidak Bau dan tidak menyengat.
                        <br>
                        Aman di Kuku dan Tidak Melukai Kuku
                        <br>
                        Bisa Di Simpan Dalam Waktu Yang Lama
                        <br>
                        </p>
                    </div>
                </div>
