        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Dengan pemakaian teratur konsentratmengandung bahan pencerah
                        <br>
                        Dengan pemakaian teratur, formula serum yang cepat meresap dapat menutrisi dan mencerahkan kulit kusam, belang dan melindunginya agar terhindar dari 10 efek negatif sinar matahari sekaligus melembabkan dan melembutkan kulitmu.
                        <br>
                        <br>
                        Kombinasi 3x bahan aktif :
                        <br>
                        Q10 mengencangkan dan menjaga elastisitas kulit.
                        <br>
                        40x Vitamin C mencerahkan dan menutrisi kulit.
                        <br>
                        NIVEA Double UV Protection melidungi kulit dari sinar matahari.
                        <br>
