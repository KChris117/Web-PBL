                ...
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text">
                            ...
                            <br> Hyaluron + Ceramide + with Chlorelina
                            <br> Netto 50ml
                            <br> Purchase Limit: 5
                            <br> Moisturizer yang diformulasikan dengan 2 jenis Hyaluron, Ceramide dan Chlorelina yang dapat membantu merawat skin
                            barrier, serta menjaga keremajaan kulit. Mengunci hidrasi pada kulit sehingga membuat kulit terasa kencang dan
                            kekencangan kulit terjaga, membantu mencegah tanda-tanda penuaan dini dengan menjaga kelembapan kulit.
                            <br>
                            <br> MANFAAT
                            <br> Membantu merawat skin barrier
                            <br> Mengunci hidrasi pada kulit
                            <br> Merawat keremajaan kulit
                        </p>
                    </div>
                </div>
