        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/lomira.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Lomira</h5>
                        <p class="card-text">Nail Enamel</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Kuku tampil lebih creative dengan berbagai warna cantik dari Nail Polish Lomira Cosmetic! Terbuat dari formulasi bahan yang ramah dan tidak membuat kuku rusak + cepat kering!
                        <br>
                        <br>
                        Tersedia dalam beberapa ragam warna dan Varian
                        <br>
                        </p>
                    </div>
                </div>
