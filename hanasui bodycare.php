        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Paket Body Lotion 3 in 1 Hanasui / Hanasui Body Care BPOM Original
                        <br>
                        ...
                        Terdiri Dari :
                        <br>
                        1. Lotion dengan Sun Screen 100ml / BPOM NA 18160103315
                        <br>
                        2. Lotion dengan Bengkoang Extract 100ml / BPOM NA 18160103316
                        <br>
                        3. Transparent Soap 80gr / BPOM NA 18160500489
                        </p>
                    </div>
                </div>
                </div>
