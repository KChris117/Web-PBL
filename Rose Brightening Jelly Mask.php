    ...
    <div class="row mt-5 no-gutter">
        <div class="col-md-2 bg-light">
            <ul class="list-group list-group-flush p-2 pt-4">
                ...
                <li class="nav-item">
                    <a class="nav-link text-muted" href="#">Nail Polish<span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-muted" href="#">Shampoo<span class="sr-only"></span></a>
                </li>
            </ul>
        </div>
        <br>
        ...
        <div class="col-md-10">
            ...
            <h4 class="text-center font-weight-bold mr-4">Detail Produk</h4>
            <br>
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <a href="#" class="btn btn-danger">Rp36.000</a>
                        <a href="#"><img src="cart.svg" alt="" width="25"></a>
                    </div>
                </div>
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        <h5 class="card-title">The Originote</h5>
                        <p class="card-text">Rose B3 Brightening Jelly Mask</p>
                        <p class="card-text">
                            The Originote B3 Rose Brightening Jelly Mask
                            <br> Netto 50gr
                            <br> Purchase Limit: 5
                            <br>The Originote Rose B3 Brightening Jelly Mask dengan kandungan Rose, Heartleaf dan Niacinamide yang dapat membantu
                            membersihkan dan memberi rasa kencang pada kulit, mencerahkan wajah serta membantu menghaluskan wajah. Biarkan pada
                            kulit selama 10-15 menit dan gunakan 1-2 kali seminggu untuk hasil yang maksimal.
                            <br> MANFAAT
                            <br> Mencerahkan Wajah
                            <br> Menghaluskan Wajah
                            <br> Membantu mengangkat kulit mati
                            <br> Membersihkan dan memberi rasa kencang pada wajah
                        </p>
                    </div>
                </div>
