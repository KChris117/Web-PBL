        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/motled.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">MOTLED</h5>
                        <p class="card-text">UV/LED GEL POLISH</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Informasi produk: URGEL
                        <br>
                        <br>
                        - Kutek gel UR berwarna-warni
                        <br>
                        - Bahan utama dalam gel polish: RESIN
                        <br>
                        - Kapasitas: 8ml
                        <br>
                        - Catatan: Produk toko adalah kutek gel, harus menggunakan pengering gel untuk mengeringkan kutek gel, dan harap ikuti petunjuk penggunaan.
                        </p>
                    </div>
                </div>
                </div>
