    ...
    <div class="row mt-5 no-gutter">
        <div class="col-md-2 bg-light">
            <ul class="list-group list-group-flush p-2 pt-4">
                ...
                <li class="nav-item active">
                    <a class="nav-link text-light bg-secondary" href="lipstick.php">Lipstick<span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/lipstick/wardah.jpeg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Wardah</h5>
                        <p class="card-text">Colorfit Ultralight Matte</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp38.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Wardah New Colorfit Ultralight Matte Lipstick
                        <br>
                        <br>
                        Wardah Colorfit Ultralight Matte Lipstick diformulasikan menggunakan teknologi color powder pigment
                        <br>
                        sehingga menghasilkan hasil powdery matte yang ringan, halus, dan tetap menjaga kelembabab bibir.
                        <br>
                        <br>
                        Dilengkapi dengan 8 warna yang disesuaikan dengan skintone wanita Indonesia,
                        <br>
                        Wardah Colorfit Ultralight Matte Lipstick cocok digunakan untuk aktivitas sehari-hari.
                        </p>
                    </div>
                </div>
                </div>
