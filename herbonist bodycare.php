        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Dengan kebaikan SEA SALT dan bahan terbaik dari alam, seperti : Volcanic Mud,
                        <br>
                        Kaolin dan Gold yang mengandung micro minerals & vitamin E. Efektif angkat
                        <br>
                        sel kulit mati, menutrisi dan menjaga hidrasi serta mencerahkan kulit mu!
                        <br>
                        <br>
                        Memiliki kandungan micro-mineral yang lebih banyak untuk menutrisi kulit hingga lapisan terdalam
                        <br>
                        Natural exfoliator yang efektif mengangkat sel kulit mati
                        <br>
                        <br>
                        Manfaat:
                        <br>
                        Mendetoksifikasi kulit dan mengaktifkan Kembali sel-sel kulit
                        <br>
                        mencerahkan kulit
                        <br>
                        Menenangkan kulit dan memberikan kelembapan pada kulit sekaligus meratakan warna kualitas
                        <br>
                        Membantu menyamarkan garis halus
                        <br>
                        Memberikan efek anti-aging dan menjaga elastisitas kualitas
                        </p>
                    </div>
                </div>
                </div>
