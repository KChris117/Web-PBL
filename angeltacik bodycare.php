            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        Manfaat :
                        <br>
                        🌷. MEMBANTU KULIT LEBIH CERAH DAN TERANG
                        <br>
                        🌷. MELINDUNGI KULIT DARI SINAR MATAHARI
                        <br>
                        🌷. MENGANDUNG UV MULTI VITAMIN E
                        <br>
                        🌷. AMAN UNTUK SMUA JENIS KULIT
                        <br>
                        🌷. MENGATASI KULIT KERING
                        <br>
                        🌷. MENGECILKAN PORI PORI PADA TANGAN MAUPUN KAKI
                        <br>
                        <br>
                        Keuntungan :
                        <br>
                        1. Wangi yg menyegarkan
                        <br>
                        2. Lembut dikulit
                        <br>
                        3. Wanginya tahan lama
                        <br>
                        4. Tidak lengket sama sekali
                        </p>
                    </div>
                </div>
                </div>
