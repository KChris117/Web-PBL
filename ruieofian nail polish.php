    ...
    <div class="row mt-5 no-gutter">
        <div class="col-md-2 bg-light">
            <ul class="list-group list-group-flush p-2 pt-4">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light bg-secondary" href="nail polish.php">Nail Polish<span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/ruieofian.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">RuieoFian</h5>
                        <p class="card-text">Soak Off UV LED GEL POLISH</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp15.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        RuioeFian Gel Nail Polish UV LED hanya bisa dikeringkan menggunakan UV LED lamp 
                        <br>
                        <br>
                        Petunjuk pemakaian:
                        <br>
                        ...
                        <br>
                        2. Oleskan Base Coat. Keringkan dengan lampu LED selama 60 detik atau lampu UV selama 2 menit.
                        <br>
                        3. Oleskan Color Nail Gel Polish. Keringkan dengan lampu LED selama 60 detik atau lampu UV selama 2 menit.
                        <br>
                        4. Oleskan Color Nail Gel Polish beberapa kali lagi jika warna dirasa kurang. Keringkan dengan lampu LED selama 60 detik atau lampu UV selama 2 menit.
                        <br>
                        5. Oleskan Top Coat. Keringkan dengan lampu LED selama 60 detik atau lampu UV selama 2 menit.
                        <br>
                        6. Hapus permukaan yg lengket dengan kapas yg dibasahi oleh pembersih. Ada kemungkinan terdapat perbedaan warna karena dapat di sebabkan oleh beberapa alasan seperti warna refleksi di dalam monitor lighting latar belakang.
                        </p>
                    </div>
                </div>
                </div>
