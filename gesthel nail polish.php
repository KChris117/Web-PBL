        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/gesthel.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Gesthel</h5>
                        <p class="card-text">UV LED POLISH</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        <br>
                        - READY STOCK, Pilih Sesuai Varian Yang Diinginkan
                        <br>
                        -  Kemasan 15ml, Botol Kaca BIG SIZE
                        <br>
                        - Untuk REAL WARNA saat di Swatch Boleh Chat kami ya
                        <br>
                        <br>
                        YANG DI DAPATKAN :
                        <br>
