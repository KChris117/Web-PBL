        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/nail polish/tone.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">"Tone"</h5>
                        <p class="card-text">Nail Lacquer</p>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Kutek Tone Matte Halal Murah 8ml | Cat Kuku Tone Nail Polish 8ml BPOM
                        <br>
                        <br>
                        <br>
                        Packing Aman. Sudah Termasuk Bubble Wrap
                        <br>
                        ✔️ 24 Warna
                        <br>
                        ✔️BPOM
                        <br>
                        ✔️ Produk 100% Original
                        <br>
                        ✔️ Bahan aman, halal dan berkualitas
                        <br>
                        ✔️ Nett: 8 ML, 
                        <br>
                        ✔️ Masa Kadaluarsa : 5 tahun
                        <br>
                        ✔️ Mudah di bersihkan
                        <br>
                        ✔️ Untuk Memperindah penampilan kuku
                        </p>
                    </div>
                </div>
                </div>
