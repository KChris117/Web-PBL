        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/lipstick/salsa.jpeg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">Salsa</h5>
                        <p class="card-text">Velvet Matte Finish</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp12.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        SALSA Matte Lipstick
                        <br>
                        <br>
                        3.5g  
                        <br>
                        <br>
                        SALSA Matte Lipstick hadir dalam 12 warna untuk mempercantik bibir Anda dan
                        tidak membuat bibir kering saat pemakaian. 
                        <br>
                        <br>
                        Dengan pilihan Shade:
                        <br>
                        01 - Darling Nude
                        <br>
                        02 - Marvel Peach
