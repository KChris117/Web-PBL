        ...
        <div class="col-md-10">
            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    <img src="assets/img/shampoo/cbd keratin.jpg" class="card-img-top" alt="...">
                    <div class="card-body bg-light">
                        <h5 class="card-title">CBD KERATIN</h5>
                        <p class="card-text">CREATIVE BEAUTY DAZZLE</p>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star text-success"></i>
                        <i class="fas fa-star-half-alt text-success"></i>
                        <i class="far fa-star text-success"></i><br>
                        <a href="#" class="btn btn-danger">Rp121.000</a>
                    ...
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Kutek BRASOV Warna Halal Murah 8ML BPOM
                        <br>
                        <br>
                        - Produk 100% Original
                        <br>
                        - 24 Warna
                        <br>
                        - Bahan aman, halal dan berkualitas
                        <br>
                        - Nett: 8 ML, 
                        <br>>
                        ...
                        - Mudah di bersihkan
                        <br>
                        - Untuk Memperindah penampilan kuku
                        </p>
                    </div>
                </div>
                </div>
