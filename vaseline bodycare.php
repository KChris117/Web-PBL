            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <a href="#"><img src="assets/logo/cart.svg" alt="" width="30"></i></a>
                    </div>
                    </div>
                    <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        <p class="card-text">
                        Serum pencerah tercanggih dan paling kuat dari Vaseline
                        <br>
                        Mengubah kulit Anda menjadi dewy dan glowing hanya dalam 5 hari.
                        <br>
                        Vaseline Gluta-Hya Serum Burst Lotion adalah lotion pertama dengan GlutaGlow dan Hyaluron yang memberikan kekuatan 10x lebih cerah daripada Vitamin C
                        <br>
                        Hadir dalam tekstur ringan yang meledak menjadi tetesan air
                        <br>
                        Produk terbaru dari Vaseline Healthy Bright, memanfaatkan kekuatan bahan perawatan wajah canggih yang menjanjikan manfaat yang lebih baik.
                        <br>
                        Diformulasi dengan Pro-Retinol yang Mengurangi Flek Hitam dan Memberikan Warna Kulit Merata. 
                        <br>
                        <br>
                        Vaseline sebagai brand Hand Body Lotion yang telah dipercaya selama ratusan tahun, percaya bahwa kulit yang benar-benar sehat dapat dimiliki oleh setiap orang, tanpa terkecuali. Untuk itu Vaseline membantu memperbaiki kulit dengan perawatan tubuh yang berkualitas dan kualitas hidup masyarakat yang membutuhkan di seluruh dunia. Melalui misi kemanusiaan secara global, yakni Vaseline Healing Project, Vaseline menyumbangkan lebih dari 1 juta produk Vaseline melalui mitra klinik dan rumah sakit, memberikan pelatihan mengenai kesehatan kulit bagi tenaga kesehatan, dan membantu memperbaiki kondisi kulit masyarakat di daerah yang paling membutuhkan.
                        </p>
                    </div>
                </div>
                </div>
