            ...
            <div class="row mx-auto">
                ...
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text">
                            The Originote Peeling Solution
                            <br> Netto 20ml
                            <br> Purchase Limit: 5
                            <br> Cairan eksfoliasi yang diformulasikan dengan AHA, BHA, PHA dan Sugar Cane yang berfungsi untuk mengangkat sel kulit
                            mati, serta merawat keremajaan kulit sehingga kulit terlihat lebih cerah.
                            <br>
                            <br> MANFAAT
                            <br> Mengangkat sel kulit mati
                            <br> Mencerahkan kulit
                        </p>
                    </div>
                </div>
