            ...
            <div class="row mx-auto">
                <div class="card ml-2 mr-2" style="width: 16rem;">
                    ...
                    <div class="card-body bg-light">
                        ...
                        Manfaat :
                        <br>
                        🌟 Membersihkan dan mengangkat kotoran dan minyak pada kulit
                        <br>
                        🌟 Soft-exfoliant, membantu mengangkat lapisan sel kulit mati
                        <br>
                        🌟 Merangsang Regenerasi sel dan produksi kolagen pada kulit
                        <br>
                        ...
                        Cara Pakai : 
                        <br>
                        1. Gunakan Shower Scub dengan bilas dan basahi tubuh, ambil secukupnya kemudian gosok lembut ke kulit tubuh secara merata dan perlahan, setelah itu bisa dibilas
                        <br>
                        2. Gunakan Body Cream, oles dan ratakan diamkan sekitar 10-15 menit lalu dibilas atau langsung mandi (Bisa juga dibilas dengan air hangat). Atau bisa juga, Oleskan Pada malam hari lalu keesokan pagi harinya dibilas atau bisa langsung mandi. Untuk Hasil Maksimal Gunakan 1 minggu 3-4x
                        <br>
                        3. Ambil lalu Oleskan Lotion ke seluruh tubuh, Gunakan rutin 1 hari 2x sehari untuk hasil lebih maksimal
                        <br>
                        Bisa digunakan untuk ibu hamil dan menyusui
                        <br>
                        NB: Kemasan baru lotion pomegranate tutup pump
                        </p>
                    </div>
                </div>
                </div>
