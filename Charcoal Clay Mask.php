            ...
            <div class="row mx-auto">
                ...
                <div class="card ml-2 mr-2" style="width: 50rem;">
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text">Charcoal Clay Mask</p>
                        <p class="card-text">
                            The Originote Charcoal Clay Mask
                            <br> Netto 50gr
                            <br> Purchase Limit: 5
                            <br> MANFAAT
                            <br> Melindungi kulit dari kerusakan akibat sinar matahariMembantu merawat skin barrier
                            <br> Merawat skin barrierMembantu Membersihkan dan memberi rasa kencang pada kulit
                            <br> Membantu menghaluskan kulit
                            <br> Membantu mengangkat kulit mati
                            <br> Membantu mencerahkan wajah
                            <br> Membantu merawat komedo dan jerawat pada wajah
                            <br> Membantu mengekfoliasi kulit, serta membantu menghilangkan minyak berlebih pada wajah
                        </p>
                    </div>
                </div>
